...
function buildCssVariables(palette) {
  ...
  return {
    ...
    "--split-board-background": `linear-gradient(180deg, ${rgba(accentStrong, 0.08 * glow)}, ${rgba(text, 0.035)}), ${rgba(text, 0.035)}`,
    "--split-board-border": rgba(palette.border, 0.12),
    "--split-board-shadow": `inset 0 1px 0 ${rgba(text, 0.055)}, inset 0 0 18px ${rgba(accentStrong, 0.045 * glow)}`,
    "--split-card-background": `linear-gradient(180deg, ${rgba(text, 0.07)}, ${rgba(text, 0.028)}), ${rgba(text, 0.028)}`,
    "--split-card-border": rgba(palette.border, 0.09),
