export const rawSquares = {
  Dogen: [
    "Dogen 005 - Isolated Platform down the hill",
  ...
  HWY0: [
    "HWY0 023 - Directly under entrance",
...
export const rawGraffiti = [
  "Dogen Spray 100% GRAFFITI",
